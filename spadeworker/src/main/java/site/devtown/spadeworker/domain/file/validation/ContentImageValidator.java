...
public class ContentImageValidator
        implements ConstraintValidator<ContentImageValidate, MultipartFile> {
    ...
    public boolean isValid(
        ...
        if (requestImage == null || requestImage.isEmpty()) {
            ...
            context.buildConstraintViolationWithTemplate("본문 이미지 값은 필수 입니다.")
    ...
    @Override
    public void initialize(ContentImageValidate constraintAnnotation) {
